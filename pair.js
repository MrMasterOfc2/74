...
function setupCommandHandlers(socket, number) {
    socket.ev.on('messages.upsert', async ({ messages }) => {
        ...
        try {
            switch (command) {
                // Case: menu - Simple menu without interactive buttons
                case 'menu': {
                    try {
...
│ • ${config.PREFIX}weather - Weather forecast
...
│ • ${config.PREFIX}ping - Check response speed
├─────────────────────────────────────
│ *Note:* Type any command with prefix
...
`;
                ...
                // All other commands removed - only menu command remains
